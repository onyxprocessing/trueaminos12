// Simple static server that immediately binds to port 5000
...
server.listen(5000, '0.0.0.0', () => {
  ...
  setTimeout(() => {
    // Path to the TrueAminoStore directory
    const appDir = path.join(__dirname, 'TrueAminoStore');
    process.chdir(appDir);
    
    // Start the app with the proper environment variables
